...
Vanadium.addValidatorTypes([
    ...
    ['equal', function(v, p) {
      ...
      return 'El valor Introducido debe ser igual a <span class="' + Vanadium.config.message_value_class + '">' + p + '\ (may&uacute;sculas y min&uacute;sculas \)</span>. '
    }],

    ['equal_ignore_case', function(v, p) {
      return v.toLowerCase() == p.toLowerCase();
    }, function (_v, p) {
      return 'El valor Introducido debe ser igual a <span class="' + Vanadium.config.message_value_class + '">' + p + '  \ (sin distinci&oacute;n entre may&uacute;las y min&uacute;las \)</span>. '
    }],

    ['required', function(v) {
      return !Vanadium.validators_types['empty'].test(v);
    }, 'Este campo no puede estar vac&iacute;o! '],
    ...
    }, 'Por favor, introduzca un valor entero v&aacute;lido. '],
 
    ['number', function(v) {
      return Vanadium.validators_types['empty'].test(v) || (!isNaN(v) && !/^\s+$/.test(v));
    }, 'Por favor, introduzca un n&uacute;mero v&aacute;lido. '],
 
    ['digits', function(v) {
      return Vanadium.validators_types['empty'].test(v) || !/[^\d]/.test(v);
    }, 'Por favor, introduzca un n&uacute;mero entero no negativo, incluyendo 0. '],

    ['digits_discim', function(v) {
      return Vanadium.validators_types['empty'].test(v) || !/[^\d\.?\d$]/.test(v);
    }, 'Por favor, introduzca un n&uacute;mero decimal v&aacute;lido, incluyendo 0. '],
 
    ['alpha', function (v) {
      return Vanadium.validators_types['empty'].test(v) || /^[a-zA-Z\u00C0-\u00FF\u0100-\u017E\u0391-\u03D6]+$/.test(v)   //% C0 - FF (? - ?); 100 - 17E (? - ?); 391 - 3D6 (? - ?)
    }, 'Por favor, introduzca las letras. '],
 
    ['asciialpha', function (v) {
      return Vanadium.validators_types['empty'].test(v) || /^[a-zA-Z]+$/.test(v)   //% C0 - FF (? - ?); 100 - 17E (? - ?); 391 - 3D6 (? - ?)
    }, 'Por favor, introduzca las letras en ASCII. '],

    ['alphanum', function(v) {
      return Vanadium.validators_types['empty'].test(v) || !/\W/.test(v)
    }, 'Por favor introduzca letras o n&uacute;meros positivos. '],

    ['email', function (v) {
      return (Vanadium.validators_types['empty'].test(v) || /\w{1,}[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/.test(v))
    }, 'incorrecto, por favor el correo (e-mail) debe cumplir el siguiente formato mrthink@gmail.com ) '],

    ['url', function (v) {
      return Vanadium.validators_types['empty'].test(v) || /^(http|https|ftp):\/\/(([A-Z0-9][A-Z0-9_-]*)(\.[A-Z0-9][A-Z0-9_-]*)+)(:(\d+))?\/?/i.test(v)
    }, 'Por favor, introduzca la direcci&oacute;n URL  correcta, como por ejemplo: http://www.mrthink.net '],
    ...
    }, 'Por favor introduce el formato de fecha correcta, como por ejemplo: 28/05/2010. '],
    ...
    ['length',
      ...
      function (_v, p) {
        return 'Introduzca  caracteres de longitud igual a <span class="' + Vanadium.config.message_value_class + '">' + p + '</span>. '
      }
    ],
    ...
    ['min_length',
      ...
      function (_v, p) {
        return 'Introduzca los caracteres de longitud igual o superior a <span class="' + Vanadium.config.message_value_class + '">' + p + '</span>. '
      }
    ],
    ['max_length',
      function (v, p) {
      ...
      function (_v, p) {
        return 'Introduzca  caracteres de longitud no superior a <span class="' + Vanadium.config.message_value_class + '">' + p + '</span>. '
      }
    ],
    ['same_as',
      function (v, p) {
      ...
      function (_v, p) {
        var exemplar = document.getElementById(p);
        if (exemplar)
          return 'No es la misma contrase&nacute;a dos veces. ';
        else
          return 'No hay valores de referencia! '
      },
      "",
    ...
    ['format',
      ...
      function (_v, p) {
        ...
        if (params.length == 3 && params[0] == "") {
          return 'El valor introducido  debe ser igual a <span class="' + Vanadium.config.message_value_class + '">' + p.toString() + '</span> . ';
        } else {
          return 'Valor proporcionado <span class="' + Vanadium.config.message_value_class + '">' + p.toString() + '</span>no coincide. ';
        }
      }
    ]
  ])
