...
//	NOVECIENTOS NOVENTA Y NUEVE MIL NOVECIENTOS NOVENTA Y NUEVE CON 99/100 Nuevos Soles.
//------		Creada por:                 	     ---------------
//------       		  TOMAS ANQUISE IBA�EZ  	  ---------------
//------            lenox.pristom@gmail.com 		  ---------------
//------		20 de Abril de 2010. Peru, CTICSPERU  ---------------
...
for($xz = 0; $xz < 3; $xz++)
	...
	while ($xexit)
			...
			switch ($xz)
				...
				case 2:
					...
					if ($xcifra >= 1 && $xcifra < 2)
						{
						$xcadena = "UNO CON $xdecimales/100 Nuevos Soles";
						}
					if ($xcifra >= 2)
						{
		...
		// ------------------      en este caso, para Peru se usa esta leyenda     ----------------
