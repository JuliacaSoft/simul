    ...
    <body>
        ...
        <div id="stylized" class="myform">
            <form id="form" name="formInsert" method="post" action="_proxy.php">
                ...
                <input type="hidden" name="accion" id="accion" value="actualizaRegla"/>
                <input type="hidden" name="reglaid" id="reglaid" value="<?php echo $u->getRegla_id() ?>"/>
