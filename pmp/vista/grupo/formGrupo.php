    ...
    <body>
        ...
        <div id="stylized" class="myform">
            <form id="form" name="formInsert" method="post" action="_proxy.php">
                ...
                <textarea name="descripcion" rows="5" cols="40" id="descripcion" />
                <div class="spacer"></div>
                <label>Peso
                ...
                <input type="hidden" name="accion" id="accion" value="insertarGrupo"/>
        ...
        <script>
            ...
            function validarPeso() {
                ...
                $.ajax({
                    url: "_proxy.php",
                    type: "GET",
                    data: "controlador=Grupo&accion=validarGrupoPeso&peso=" + $("#peso").val(),
                    success: function(r) {
                        $("#mensaje").html(r);
                        dato = $("#correct").val();
