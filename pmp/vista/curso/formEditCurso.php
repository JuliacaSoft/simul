    ...
    <body>
        ...
        <div id="stylized" class="myform">
            <form id="form" name="formInsert" method="post" action="_proxy.php">
                ...
                <input type="hidden" name="accion" id="accion" value="actualizaCurso"/>
                <input type="hidden" name="cursoid" id="cursoid" value="<?php echo $ar->getCurso_id() ?>"/>
