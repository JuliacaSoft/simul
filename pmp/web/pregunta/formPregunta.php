...
<html>
    <head>
        ...
        <link rel="stylesheet" href="recursosg/css/upload/bootstrap.min.css">
        <!-- Generic page styles -->
        <link rel="stylesheet" href="recursosg/css/upload/style.css">
        <!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
        <link rel="stylesheet" href="recursosg/css/upload/jquery.fileupload.css">
...
<script src="recursosg/js/upload/jquery.min.js"></script>
<!-- The jQuery UI widget factory, can be omitted if jQuery UI is already included -->
<script src="recursosg/js/upload/jquery.ui.widget.js"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script src="recursosg/js/upload/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="recursosg/js/upload/jquery.fileupload.js"></script>
<!-- Bootstrap JS is not required, but included for the responsive demo navigation -->
<script src="recursosg/js/upload/bootstrap.min.js"></script>
