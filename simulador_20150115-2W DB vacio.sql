...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-01-2015 a las 19:49:06
...
CREATE TABLE IF NOT EXISTS `preguntas` (
  `preguntas_id` int(4) NOT NULL AUTO_INCREMENT,
  `excel_id` int(4) DEFAULT NULL,
  `pregunta_es` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `pregunta_us` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `imagen_es` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `imagen_us` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `respuesta` varchar(1) COLLATE utf8_bin DEFAULT NULL,
  `opcion_aes` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `opcion_bes` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `preguntas` (`preguntas_id`, `excel_id`, `pregunta_es`, `pregunta_us`, `imagen_es`, `imagen_us`, `respuesta`, `opcion_aes`, `opcion_bes`) VALUES
(5, 1, 'Â¿En  Ã±andÃº  quÃ© momento del ciclo de vida de un proyecto genÃ©rico  el costo y la dotaciÃ³n de personal son mÃ¡s altos? ', 'EE Ã±andÃº  Â¿En quÃ© momento del ciclo de vida de un proyecto genÃ©rico  el costo y la dotaciÃ³n de personal son mÃ¡s altos? ', 'image.jpg', 'imge.jpg', 'B', 'En el inicio', 'Cuando el proyecto se estÃ¡ realizando'),
(6, 2, 'Â¿CuÃ¡l Ã±andÃº  de las siguientes es una tÃ©cnica o herramienta del proceso de desarrollo del plan de proyecto?', 'EE Ã±andÃº  Â¿En quÃ© momento del ciclo de vida de un proyecto genÃ©rico  el costo y la dotaciÃ³n de personal son mÃ¡s altos? ', 'image.jpg', 'imge.jpg', 'B', 'MÃ©todos de selecciÃ³n de proyectos', 'TÃ©cnicas de facilitaciÃ³n');
